...
Day to day, I write theoretical economic models and prove that they possess certain properties or compute them. Sometimes I use data to compute things, with or without a theoretical model. In my free time I create [silly Twitter bots](https://twitter.com/bakRabot), play video games (usually online RTS games and single-player RPGs), and think about the economics of fictional worlds.
